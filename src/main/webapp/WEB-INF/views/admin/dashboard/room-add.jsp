        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tạo phòng mới</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/dashboard/room/add" id="roomAddForm">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Thêm phòng này</button>
                </div>
              </form>
            </div>
          </div>
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/hostJs/add-room.js"></script>
</body>
</html>
