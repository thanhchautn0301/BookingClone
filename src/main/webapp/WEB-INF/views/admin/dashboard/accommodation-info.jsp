  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thông tin các chỗ nghỉ</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý chỗ nghỉ</a></li>
              <li class="breadcrumb-item active">Xem danh sách chỗ nghỉ</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách chỗ nghỉ</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/hostJs/accomodation-info.js"></script>
</body>
</html>
