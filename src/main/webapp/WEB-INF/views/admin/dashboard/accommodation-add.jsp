  ...
  <aside class="main-sidebar sidebar-dark-navy elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Anh Châu</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm chỗ nghỉ</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý chỗ nghỉ</a></li>
              <li class="breadcrumb-item active">Tạo chỗ nghỉ</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form method="post" enctype="multipart/form-data"
               action="${pageContext.request.contextPath}/admin/dashboard/accommodation/add" id="accomodationAddForm">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Thêm chỗ nghỉ này</button>
                </div>
              </form>
            </div>
          </div>
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/hostJs/add-accomodation.js"></script>
</body>
</html>
