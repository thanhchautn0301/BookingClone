        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/admin/dashboard/room/type" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kiểu phòng</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Kiểu phòng</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý phòng</a></li>
              <li class="breadcrumb-item active">Kiểu phòng</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <form method="post" action="${pageContext.request.contextPath }/admin/dashboard/room/type/add" id="roomAddForm" class="card collapsed-card">
              ...
              <div class="card-body">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <select name="quantityAdult" class="form-control">
                        ...
                        <option value="4">4 đứa</option>
                        <option value="5">5 đứa</option>
                        <option value="6">6 đứa</option>
                        <option value="7">7 đứa</option>
                        <option value="8">8 đứa</option>
                        <option value="9">9 đứa</option>
                        <option value="10">10 đứa</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" rows="3" placeholder="Mô tả của kiểu phòng..."></textarea>
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">Thêm kiểu phòng</button>
              </div>
            </form>
          </div>
        </div>
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/hostJs/room-type.js"></script>
</body>
</html>
