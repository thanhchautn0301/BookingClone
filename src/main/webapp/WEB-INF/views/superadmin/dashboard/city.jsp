...
<head>
 ...
 <link
    ...
    <!-- DataTables -->
 	<!-- SweetAlert2 -->
 <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/dashboard/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
 <!-- Toastr -->
 <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/dashboard/plugins/toastr/toastr.min.css">    
</head>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/superadmin/dashboard/city" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thành phố</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tạo thành phố</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý khách sạn</a></li>
...
<div class="modal fade" id="modal-info">
  <div class="modal-dialog h-100 my-0 py-3">
    <form action="${pageContext.request.contextPath }/superadmin/dashboard/city/edit" method="post" id="editForm" class="modal-content">
...
<!-- SweetAlert2 -->
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/sweetalert2/sweetalert2.min.js"></script>
<!-- Toastr -->
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/toastr/toastr.min.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/adminJs/add-city.js"></script>
</body>
</html>
