<%@page import="com.booking.entities.Role"%>
  ...
  <aside class="main-sidebar sidebar-dark-navy elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Anh Lộc (Admin)</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/superadmin/dashboard/staff/add" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Staff</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="${pageContext.request.contextPath}/superadmin/dashboard/staff/info" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tạo Staff</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Quản lý Staff</a></li>
              <li class="breadcrumb-item active">Thêm Staff</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              <form method="post" action="${pageContext.request.contextPath}/superadmin/dashboard/staff/add" id="staffAddForm">
                <div class="card-body">
                  <div class="form-group">
                    <label>Tên Staff</label>
                    <input type="text" placeholder="Nhập tên Staff" class="form-control" name="name" id="">
                  </div>
                  <div class="form-group">
                    <label>Ngày sinh</label>
                      <div class="input-group w-25 date" id="dob" data-target-input="nearest">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập CCCD-CMND" class="form-control" name="civilIdentity" id="">
                  </div>   
                  <div class="form-group">
                    ...
                    <c:forEach var="role" items="${roles }" varStatus="index">
	                    <div class="custom-control d-inline-block mr-2 custom-radio">
	                      ...
	                      <%  Role roleItem = (Role) pageContext.getAttribute("role");
	                      	...
	                      	else if(roleItem.getName().equalsIgnoreCase("ROLE_USER")){
	                      		role_name = "Customer";
	                      	}
	                      %>  
	                      <label for="${index.index}" class="font-weight-normal custom-control-label">  
	                     	 <%= role_name %>              
	                      </label>
	                    </div>  
                    </c:forEach>  
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Thêm Staff</button>
                </div>
              </form>
            </div>
          </div>
...
<script src="${pageContext.request.contextPath}/resources/dashboard/plugins/adminJs/add-staff.js"></script>
</body>
</html>
