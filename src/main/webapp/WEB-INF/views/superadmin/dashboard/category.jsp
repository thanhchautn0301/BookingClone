...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  ...
  <html lang="en">
    <head>
      ...
      <link
        rel="stylesheet"
        href="${pageContext.request.contextPath}/resources/dashboard/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css"
      />
      <!-- Select2 -->
      <link
        rel="stylesheet"
      ...
      <link
        rel="stylesheet"
        href="${pageContext.request.contextPath}/resources/dashboard/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css"
      />
      <!-- iCheck -->
      <link
        rel="stylesheet"
      ...
      <link
        rel="stylesheet"
        href="${pageContext.request.contextPath}/resources/dashboard/plugins/daterangepicker/daterangepicker.css"
      />
      <link
        rel="stylesheet"
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <nav class="mt-2">
              ...
              >
                ...
                <li class="nav-item menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="${pageContext.request.contextPath}/superadmin/dashboard/category" class="nav-link active">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Danh mục</p>
                      </a>
                    </li>
        ...
        <div class="content-wrapper">
          ...
          <section class="content">
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-12">
                  <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/superadmin/dashboard/category/add" class="card collapsed-card" id="addForm">
                    <div class="card-header">
                      <h3 class="card-title">Danh sách danh mục</h3>
                      <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
      ...
      <div class="modal fade" id="modal-info">
        <div class="modal-dialog h-100 my-0 py-3">
          <form action="${pageContext.request.contextPath }/superadmin/dashboard/category/edit" method="post" id="editForm" class="modal-content">
      ...
      <script src="${pageContext.request.contextPath}/resources/dashboard/plugins/adminJs/add-category.js"></script>
    </body>
  </html>
