...
public class RoomHome {
    ...
    public RoomHome(Integer id, Integer accomodation_id, String accomodation_name, Integer roomType_id, String roomType_name, Integer staff_id, String name, String description,  boolean status, double price,String image) {
        this.id = id;
    ...
    public RoomHome(Integer id, Integer accomodation_id, String accomodation_name, Integer roomType_id,
