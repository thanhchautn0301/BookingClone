...
public class BookingDetail {
    ...
    public BookingDetail(Integer id, Integer bookingId, Integer roomId, Integer quantityAdult, Integer quantityChildren, Date checkin, Date checkout, boolean status) {
        this.id = id;
